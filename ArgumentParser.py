...
class ArgumentParser:
    ...
    def ConfigureParser(self):
        parser = argparse.ArgumentParser(prog='iptrace.py', usage='iptrace.py [-h] [-v] [-a] [-m] [--visual htmloutputfile] [-o outputfile] (-l inputfile)/(-i ipaddr)', description='Automation script for ip lookup', epilog='At least one of the -l or -i option must be declared!')
        ...
        parser.add_argument('-V', '--visual', type=argparse.FileType('w'), help='Create Visual Map and display it (Expects file location)')
